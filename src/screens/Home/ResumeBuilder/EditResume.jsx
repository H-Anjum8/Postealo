...
//   // ✅ Save Resume
//   const handleSave = () => {
//     const resumeData = { message, experience, education, certifications, skills, languages };
...
//       resumeData: { message, experience, education, certifications, skills, languages },
//     });
//   };
...
//           textInputStyle={{ height: verticalScale(120), textAlignVertical: 'top' }}
//         />
...
//                   value={exp.startDate}
//                   editable={false}
//                   leftIcon={<Ionicons name="calendar-outline" size={20} color={BASE_COLORS.PRIMARY} />}
//                 />
//               </TouchableOpacity>
//               <TouchableOpacity
//                 style={styles.dateInput}
...
//             label="Add More"
//             onPress={() =>
//               setExperience([...experience, { jobTitle: '', company: '', startDate: '', endDate: '' }])
//             }
...
//             label="Add More"
//             onPress={() =>
//               setEducation([...education, { degree: '', institute: '', graduationYear: '' }])
//             }
//             style={styles.addBtnSmall}
//           />
//         </View>
...
//           <CustomButton
//             label="Add More"
//             onPress={() => setCertifications([...certifications, { name: '', issuer: '', year: '' }])}
//             style={styles.addBtnSmall}
//           />
//         </View>
...
//           <CustomButton
//             label="Add More"
//             onPress={() => setLanguages([...languages, { language: '', proficiency: '' }])}
//             style={styles.addBtnSmall}
//           />
//         </View>
...
//           />
//         </View>
//         <CustomButton label="Save" style={styles.saveBtn} onPress={handleSave} />
//       </ScrollView>
...
//     height: 40,
//   },
//   bottomButtons: { flexDirection: 'row', justifyContent: 'space-between', marginVertical: verticalScale(15) },
//   secondaryBtn: { flex: 1, marginHorizontal: 5, backgroundColor: BASE_COLORS.PRIMARY_LIGHT, height: 50 },
