...
const ResumePreview = () => {
  ...
  // 📝 Handlers
  const handleEdit = () => {
    navigation.navigate('edit_resume');
  };
  ...
  return (
    <AuthWrapper>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            A detail-oriented Business Analyst with 5+ years of experience in
            analyzing business processes and delivering data-driven solutions.
            Skilled in data analysis, process optimization, and stakeholder
            collaboration. Proficient in SQL, Excel, and Power BI. Seeking to
            apply my expertise in business analysis to drive growth at Tech
            Solutions Inc..
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            Innovative Solutions Ltd., San Francisco, CA
          </Text>
      ...
      <View style={styles.bottomButtons}>
        ...
        <CustomButton
          label="Save"
          onPress={() => navigation.navigate('pdf_preview')}
